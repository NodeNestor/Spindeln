...
class TwitterAgent(BaseAgent):
    ...
    async def run(self, person: Person) -> Person:
        ...
        # Step 1: Search for profiles on both twitter.com and x.com
        query = f'"{person.namn}" site:twitter.com OR site:x.com'
        ...
        for result in results[:3]:
            if "twitter.com" not in result.url and "x.com" not in result.url:
                continue
