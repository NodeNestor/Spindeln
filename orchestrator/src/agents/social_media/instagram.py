"""Instagram agent — discovers Instagram profiles via SearXNG + Crawl4AI."""
...
@register_agent("instagram")
class InstagramAgent(BaseAgent):
    """Discovers and verifies Instagram profiles for a person."""
    ...
    def description(self) -> str:
        return "Instagram — profile discovery and verification"
